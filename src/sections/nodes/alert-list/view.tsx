    ...
    <Box sx={{ borderBottom: '1px solid #2A3142' }}>
      ...
      <Collapse in={expanded} unmountOnExit>
        <Stack direction="row" alignItems="center" sx={{ pl: 6, pr: 6, bgcolor: '#161C25' }}>
          ...
          >
            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 9.4H18M16.8889 9.4V17.8C16.8889 18.4 16.3333 19 15.7778 19H10.2222C9.66667 19 9.11111 18.4 9.11111 17.8V9.4M10.7778 9.4V8.2C10.7778 7.6 11.3333 7 11.8889 7H14.1111C14.6667 7 15.2222 7.6 15.2222 8.2V9.4M11.8889 12.4V16M14.1111 12.4V16" stroke="#667085" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </Box>
        </Stack>
      </Collapse>
    ...
    <DashboardContent maxWidth="xl">
      ...
      <Box sx={{ mt: 3, borderRadius: '8px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        ...
        <Box sx={{ bgcolor: '#202838', border: '1px solid #202838' }}>
          {isLoading && (
            <Typography sx={{ p: 2, color: '#AFB7C8', fontSize: 15 }}>{t('loading')}</Typography>
          )}
          {!isLoading && rows.length === 0 && (
            <Typography sx={{ p: 2, color: '#AFB7C8', fontSize: 15 }}>{t('empty')}</Typography>
          )}
          {rows.map((row) => (
