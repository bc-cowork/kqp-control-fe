...
export const endpoints = {
  ...
  layouts: {
    ...
    preview: (node: string) => `/apik/${node}/layout/preview`,
  },
  identify: {
  ...
  report: {
    list: (node: string) => `/apik/${node}/report/list`,
    detail: (node: string, reportName: string) => `/apik/${node}/report/${reportName}`,
  },
  alert: {
  ...
  status: {
    list: (node: string) => `/apik/${node}/service/status`,
  },
  spec: {
  ...
  nodes: {
    info: (node: string) => `/apik/${node}/node/info`,
    channelInbound: {
