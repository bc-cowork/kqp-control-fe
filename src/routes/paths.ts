...
export const paths = {
  ...
  dashboard: {
    ...
    nodes: {
      ...
      alertsAdd: (node: string) => `/dashboard/nodes/${node}/alerts-list/add`,
      alertsDetail: (node: string, alertId: string) => `/dashboard/nodes/${node}/alerts-list/${encodeURIComponent(alertId)}`,
      alertsEdit: (node: string, alertId: string) => `/dashboard/nodes/${node}/alerts-list/${encodeURIComponent(alertId)}/edit`,
