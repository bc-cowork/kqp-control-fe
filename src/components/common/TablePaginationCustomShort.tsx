...
const TablePaginationCustomShort = ({
  ...
  // Enabled arrows: white on the dark table header, greyish on the light background.
  const enabledColor = theme.palette.mode === 'dark' ? '#F0F1F5' : grey[400];
          ...
          <SvgIcon sx={{ height: 16, width: 16 }}>
            ...
            >
              <path
                ...
                fill={firstDisabled || page === 0 ? grey[300] : enabledColor}
              />
            </svg>
          </SvgIcon>
        </CustomIconButton>
          ...
          <SvgIcon sx={{ height: 16, width: 16 }}>
            ...
            >
              <path
                ...
                fill={prevDisabled || page === 0 ? grey[300] : enabledColor}
              />
            </svg>
          </SvgIcon>
        </CustomIconButton>
          ...
          <SvgIcon sx={{ height: 16, width: 16 }}>
            ...
            >
              <path
                ...
                fill={nextDisabled || page >= lastPage ? grey[300] : enabledColor}
              />
            </svg>
          </SvgIcon>
        </CustomIconButton>
          ...
          <SvgIcon sx={{ height: 16, width: 16 }}>
            ...
            >
              <path
                ...
                fill={lastDisabled || page >= lastPage ? grey[300] : enabledColor}
              />
            </svg>
          </SvgIcon>
        </CustomIconButton>
