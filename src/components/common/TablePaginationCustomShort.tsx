          ...
          <SvgIcon sx={{ height: 16, width: 16 }}>
            ...
            >
              <path
                ...
                fill={firstDisabled || page === 0 ? grey[300] : grey[400]}
              />
            </svg>
          </SvgIcon>
        </CustomIconButton>
          ...
          <SvgIcon sx={{ height: 16, width: 16 }}>
            ...
            >
              <path
                ...
                fill={prevDisabled || page === 0 ? grey[300] : grey[400]}
              />
            </svg>
          </SvgIcon>
        </CustomIconButton>
          ...
          <SvgIcon sx={{ height: 16, width: 16 }}>
            ...
            >
              <path
                ...
                fill={nextDisabled || page >= lastPage ? grey[300] : grey[400]}
              />
            </svg>
          </SvgIcon>
        </CustomIconButton>
          ...
          <SvgIcon sx={{ height: 16, width: 16 }}>
            ...
            >
              <path
                ...
                fill={lastDisabled || page >= lastPage ? grey[300] : grey[400]}
              />
            </svg>
          </SvgIcon>
        </CustomIconButton>
