      ...
      >
        <Stack direction="row" alignItems="center" spacing={0}>
          ...
          {node && (
            <Box
              sx={{
                backgroundColor: theme.palette.mode === 'dark' ? '#212447' : '#5E66FF',
                px: 1,
                borderRadius: '4px',
                height: 32,
                display: 'flex',
          ...
          {pages &&
            pages.map((page, index) => {
              ...
              const fillNextIcon = theme.palette.mode === 'dark' ? theme.palette.grey[500] : '#667085';
                  ...
                  {!isLast && page?.link ? (
                    <Link
                      ...
                      sx={{
                        ...
                        padding: '0px 4px',
                        borderRadius: '8px',
                        '&:hover': { backgroundColor: theme.palette.mode === 'dark' ? grey[600] : grey[200], textDecoration: 'none' },
                      }}
                    >
                      {page.pageName}
                    </Link>
    ...
    <Box sx={{ display: 'flex', alignItems: 'center', flexShrink: 0 }}>
      <IconButton
        ...
        sx={{
          ...
          '&:active': {
            backgroundColor: theme.palette.mode === 'dark' ? bgColors.pressed : grey[200],
          },
        }}
      >
  ...
  return (
    <Button
      ...
      sx={{
        ...
        '&:hover': {
          backgroundColor: theme.palette.mode === 'dark' ? theme.palette.grey[500] : 'white',
          border: `1px solid${theme.palette.mode === 'dark' ? theme.palette.grey[200] : 'theme.palette.grey[200]'}`,
        },
        '&:active': {
