...
export const CustomIconButton = styled(IconButton)(({ theme }) => ({
  ...
  '&:not(.Mui-disabled)': {
    ...
    backgroundColor: theme.palette.mode === 'dark' ? theme.palette.grey[600] : '#FFFFFF',
    border: theme.palette.mode === 'dark' ? `1px solid ${theme.palette.grey[400]}` : `1px solid #E0E4EB`,
  },
  '&.Mui-disabled': {
    border: 'none',
...
const PageButton = styled(Button)(({ theme }) => ({
  ...
  margin: '0 4px',
  borderRadius: '24px',
  color: theme.palette.mode === 'dark' ? theme.palette.grey[300] : '#667085',
  fontWeight: 400,
  '&:hover': {
    backgroundColor: theme.palette.mode === 'dark' ? theme.palette.grey[200] : '#E0E4EB',
    color: theme.palette.grey[800],
  },
  '&.Mui-selected': {
    backgroundColor: theme.palette.mode === 'dark' ? theme.palette.grey[400] : '#E0E4EB',
    color: theme.palette.mode === 'dark' ? theme.palette.grey[200] : '#373F4E',
    '&:hover': {
      backgroundColor: theme.palette.grey[300],
      color: theme.palette.grey[800],
    },
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', mr: 1 }}>
          <CustomTypography sx={{
            ...
            color: theme.palette.mode === 'dark' ? theme.palette.grey[200] : '#667085',
            width: '110px'
          }}>{t('table.rows_per_page')}:</CustomTypography>
          <CustomSelect
            value={rowsPerPage}
            ...
            <SvgIcon sx={{ height: 16, width: 16 }}>
              ...
              >
                <path
                  ...
                  fill={page === 0 ? (theme.palette.mode === 'dark' ? '#667085' : '#D1D6E0') : (theme.palette.mode === 'dark' ? '#D1D6E0' : '#667085')}
                />
              </svg>
            </SvgIcon>
          </CustomIconButton>
            ...
            <SvgIcon sx={{ height: 16, width: 16 }}>
              ...
              >
                <path
                  ...
                  fill={!hasPreviousPage ? (theme.palette.mode === 'dark' ? '#667085' : '#D1D6E0') : (theme.palette.mode === 'dark' ? '#D1D6E0' : '#667085')}
            ...
            <SvgIcon sx={{ height: 16, width: 16 }}>
              ...
              >
                <path
                  ...
                  fill={!hasNextPage ? (theme.palette.mode === 'dark' ? '#667085' : '#D1D6E0') : (theme.palette.mode === 'dark' ? '#D1D6E0' : '#667085')}
                />
              </svg>
            </SvgIcon>
          </CustomIconButton>
            ...
            <SvgIcon sx={{ height: 16, width: 16 }}>
              ...
              >
                <path
                  ...
                  fill={page >= lastPage ? (theme.palette.mode === 'dark' ? '#667085' : '#D1D6E0') : (theme.palette.mode === 'dark' ? '#D1D6E0' : '#667085')}
                />
              </svg>
            </SvgIcon>
          </CustomIconButton>
